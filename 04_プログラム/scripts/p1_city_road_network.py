...
A31A_COVERAGE: dict[str, list[str]] = {
    ...
    "08222": [],                  # 鹿嶋市（沿岸・北浦汽水域。河川洪水想定なし。対象外）
    "08223": ["08_10"],           # 潮来市
    "08224": ["08_20"],           # 守谷市
    ...
    "08232": [],                  # 神栖市（利根川河口・沿岸。利根川系08_10未収録。対象外）
    ...
    "08341": [],                  # 東海村（海岸段丘台地。那珂川浸水域が北境界170m外止まり。対象外）
    "08364": ["08_10"],           # 大子町
    "08442": ["08_20"],           # 美浦村
    "08443": ["08_20"],           # 阿見町
    "08447": ["08_20"],           # 河内町
    "08521": ["08_20"],           # 八千代町（08_20: 3,098件）
    "08542": [],                  # 五霞町（利根川・渡良瀬川合流部。利根川系08_10未収録。データ制約。対象外）
    "08546": ["08_20"],           # 境町（08_20: 2,168件）
    "08564": ["08_20"],           # 利根町
}

A31A_EXCLUDED: dict[str, str] = {
    "08222": "対象外(沿岸・汽水域:河川洪水想定なし)",
    "08232": "対象外(利根川河口・沿岸:利根川系A31a未収録)",
    "08341": "対象外(海岸段丘台地:那珂川浸水域が市境外止まり)",
    "08542": "対象外(利根川・渡良瀬川合流部:利根川系A31a未収録)",
}
