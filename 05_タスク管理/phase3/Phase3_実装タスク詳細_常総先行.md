...
| **DOC-FIG** | Phase 1〜3図表フロー同期・論文用結果図 | Codex | E3,V4 | △ フロー同期完了（2026-07-20・Phase 3実装評価フロー/図表一覧新設、共通UML・評価フレーム・Phase 2図を現行仕様化、ECDF接続）。残＝図4-7-1・図5-4-1・図5-5-1の静的画像。Phase 3渋滞/worst-off図はRQ判断待ち |
