...
> 作成日：2026/04/28  
> 最終更新：2026/05/18（Phase 2完了に伴い全域拡張スクリプト・出力構造を反映）
...
│   ├── p2_evaluate_results.py       ✅          評価CSV・Phase 1/2 比較表・主要避難路集計生成
...
│       ├── derived/                             ← p2_sumo_mapping.py / p2_derived_data.py / p2_sumo_snap.py の出力
...
│       ├── evaluation/                          ← p2_evaluate_results.py の出力
│       │   ├── evacuation_summary.csv           常総市 small/10pct/full 到着・未到着・逃げ遅れ
